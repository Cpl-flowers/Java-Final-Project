...
public class UI extends game{
        ...
        // A method that creates the starting screen for the user
        public void createUI(choiceHandler xHandler) {
                ...
                startButton.addActionListener(xHandler);
